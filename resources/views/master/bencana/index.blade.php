...
@section('title','Data Master - Jenis Bencana')
    ...
    <div class="flex justify-between items-center">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm">
                Kelola data master jenis bencana
            </p>
        </div>

        <a href="{{ route('jenis-bencana.create') }}"
    ...
    <div class="bg-white shadow rounded-xl overflow-hidden border border-gray-100">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-orange-50/40 transition">
                    ...
                    <td class="px-5 py-3">
                        ...
                        <div class="flex justify-center gap-2">
                            ...
                            {{-- EDIT --}}
                            <a href="{{ route('jenis-bencana.edit',$bencana->id) }}"
                            class="px-3 py-1 text-xs font-medium rounded-md bg-orange-500 text-white hover:bg-orange-600 transition">
                                Edit
                            </a>

                            {{-- DELETE --}}
                            <form action="{{ route('jenis-bencana.destroy',$bencana->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    ...
                    class="px-5 py-8 text-center text-gray-400">
                        Data jenis bencana belum tersedia
                    </td>
                </tr>
        ...
        <div class="flex justify-between items-center px-5 py-3 bg-white">
            ...
            <div class="text-sm text-gray-500">
                Showing {{ $bencanas->firstItem() }}
                to {{ $bencanas->lastItem() }}
                of {{ $bencanas->total() }} results
            </div>

            <div>
                {{ $bencanas->onEachSide(1)->links() }}
            </div>
